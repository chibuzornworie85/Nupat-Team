  ...
  return (
    <>
      <div
        ...
        className="nav flex px-0 gap-20 lg:gap-2 bg-black xl:flex items-center justify-around xl:gap-16 sticky top-0 xl:px-4 z-10 md:gap-[580px]"
      >
      ...
      <div
        style={{ fontFamily: "Montserrat" }}
        className="rec text-white py-6 md:py-10 lg:py-10 xl:py-10 pl-7 text-xs md:pl-14 lg:pl-[50px] lg:text-2xl xl:pl-[100px] md:text-xl xl:text-2xl font-semibold"
      >
        <h1 data-aos="zoom-in">
      ...
      <div
        data-aos="zoom-in"
        style={{ fontFamily: "Montserrat" }}
        className=" text-base md:text-2xl xl:text-2xl lg:text-2xl flex justify-around items-center pt-10 xl:flex xl:justify-end lg:flex lg:justify-end lg:px-0 xl:px-10 xl:ml-0 lg:ml-36"
      >
        <div className=" what1 md:text-xl xl:text-[20px] lg:text-[20px] flex flex-col gap-4 px-6 xl:px-0 lg:px-0 md:px-14 lg:w-[600px] xl:w-[702px] xl:ml-[180px]">
