const Admistration = () => {
  ...
  return (
    <>
      ...
      <div
        style={{ fontFamily: "Montserrat" }}
        className="rec text-white py-6 md:py-10 lg:py-10 xl:py-10 pl-10 text-xs md:pl-14 lg:pl-20 xl:pl-[90px] md:text-xl lg:text-2xl xl:text-2xl font-semibold"
      >
        <h1>
      ...
      <div className="bg-black bg-no-repeat bg-center bg-cover">
        <div className=" xl:py-32 md:py-14 lg:py-32 lg:pl-20 md:pl-14 py-12 pl-7 text-white xl:pl-[90px]">
          <h1 className=" font-semibold text-base md:text-xl lg:text-4xl lg:pb-4 md:pb-4 xl:text-4xl xl:pb-4 pb-2">
      ...
      >
        <div className="flex flex-col gap-4 text-lg lg:text-3xl xl:text-3xl md:px-10 lg:px-0 xl:px-0">
        ...
        <div className="it1 bg-[url('/src/assets/admi/stage.png')] bg-no-repeat bg-cover bg-center rounded-2xl ml-5 lg:ml-0 lg:mt-0 lg:w-2/4 lg:h-96 xl:ml-0 mt-8 xl:mt-0 xl:w-2/4 h-52 xl:h-96 flex justify-center md:mx-24 lg:mx-0 xl:mx-0">
          <div className=" text-2xl xl:text-5xl lg:text-5xl text-white flex justify-center items-center font-semibold">
      ...
      >
        ...
        <div className=" what flex flex-col gap-4 px-6 xl:px-0 lg:px-0 md:px-14 xl:w-[702px] xl:ml-[160px]">
