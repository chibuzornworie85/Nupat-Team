const Admistration = () => {
  ...
  return (
    <>
      ...
      <div
        style={{ fontFamily: "Montserrat" }}
        className="rec text-white py-6 md:py-10 lg:py-10 xl:py-10 pl-10 text-xs md:pl-14 lg:pl-20 xl:pl-[80px] md:text-xl lg:text-2xl xl:text-2xl font-semibold"
      >
        <h1>
      ...
      <div className="bg-black bg-no-repeat bg-center bg-cover">
        <div className=" xl:py-32 md:py-14 lg:py-32 lg:pl-20 md:pl-14 py-12 pl-7 text-white xl:pl-[80px]">
