const It = () => {
  ...
  return (
    <>
      ...
      <div
        style={{ fontFamily: "Montserrat" }}
        className="rec text-white py-6 lg:py-10 md:py-10 xl:py-10 md:pl-14 pl-10 text-xs md:text-xl lg:pl-28 xl:pl-[90px] lg:text-2xl xl:text-2xl font-semibold"
      >
        <h1>
      ...
      >
        <div className=" xl:py-32 lg:py-32 py-12 pl-7 text-white xl:pl-[90px] lg:pl-28 md:pl-14">
          <h1 className=" font-semibold text-base xl:text-4xl md:text-2xl lg:text-4xl lg:pb-4 xl:pb-4 pb-2">
      ...
      <div
        style={{ fontFamily: "Montserrat" }}
        className=" flex flex-col lg:flex-row xl:flex-row justify-around px-12 lg:px-4 mt-10 xl:px-12"
      >
        ...
        <div className="it1 bg-[url('/src/assets/it/bg1.png')] bg-no-repeat bg-cover bg-center rounded-2xl ml-5 xl:ml-0 mt-8 lg:mt-0 xl:mt-0 lg:w-2/4 xl:w-2/4 h-52 lg:h-96 xl:h-96 flex justify-center md:mx-24 xl:mx-0 lg:mx-0">
          <div className=" text-2xl lg:text-5xl xl:text-5xl text-white flex justify-center items-center font-semibold">
            <h1>IT Solution</h1>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="what flex flex-col gap-4 px-6 xl:px-0 lg:px-0 md:px-14 w-[702px] xl:ml-[150px]">
          ...
          <h1 className=" font-semibold xl:hidden lg:hidden">
            Do you need a business <br /> innovation that integrates and <br />{" "}
            is driven by next-generation technology?
          </h1>
      ...
      <div
        style={{ fontFamily: "Montserrat" }}
        className=" xl:flex flex justify-center md:justify-start lg:justify-start xl:justify-start pt-8 xl:pt-16 md:pt-16 lg:pt-16 xl:pl-10 md:pb-20 lg:pb-20 xl:pb-20 mx-14"
      >
