const Team = () => {
  ...
  return (
    <>
      <div style={{ fontFamily: "Montserrat" }} className="nav flex px-0 gap-20 bg-black lg:flex items-center justify-around lg:gap-16 sticky top-0 lg:px-14 z-10 ">
      ...
      <div style={{ fontFamily: "Montserrat" }} className="back flex h-40 justify-center items-center text-center">
        <div className="">
          <h1 className="hit font-semibold text-base pb-4">
          MANAGEMENT TEAM
          </h1>
      ...
      <div style={{ fontFamily: "Montserrat" }} className=" flex flex-col items-center gap-8 font-semibold pt-8">
        <div>
          ...
          <div className="text flex justify-center items-center flex-col pt-40 text-lg h-80 w-80">
            ...
            <button className=" bg-[#1F335F] text-white mt-4 px-4 py-1 rounded-lg">See More</button>
          </div>
        </div>
        <div>
          <div className=" h-72 w-72 rounded-3xl relative left-4 -mt-52 top-52">
      ...
      <div style={{ fontFamily: "Montserrat" }} className="lg:hidden flex justify-center mx-14">
      ...
      <div style={{fontFamily:'Montserrat'}} className=" mt-10 xl:mt-24 md:mt-10 text-white md:text-xl xl:text-base lg:text-base text-sm p-8 xl:px-20 lg:px-16 pt-10 bg-black mx-4 lg:mx-0 xl:mx-0">
        <div className=" xl:flex flex flex-col xl:flex-row lg:flex-row justify-around">
          <div className="relative bottom-6">
            ...
            <p className=" relative bottom-7 -mb-0 w-[296px]">
              NUPAT Teams is a Business Process Outsourcing firm whose
              business is to increase clients' productivity,
              operational efficiency, and in turn profit by taking over
              some of their intensive business processes.
            </p>
          </div>
          <div>
